// entryFilter.js
// Pure decision logic: given an alert object (same shape your Telegram bot
// already builds), decide whether it's worth a simulated entry.
// Returns { pass: boolean, reasons: string[] } so rejections are auditable.

const config = require('./config');

function evaluateEntry(alert) {
  const reasons = [];
  const {
    score,
    walletCount,
